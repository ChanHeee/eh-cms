...
<section class="mb-7 flex flex-col w-full mx-auto select-none">
  <div class="flex text-sm">
    ...
    <div
      class="overflow-x-hidden flex flex-col flex-auto divide-y border-l border-b border-t"
    >
      <div
        class="flex justify-center px-3 bg-[#D9D9D8] font-bold divide-b divide-x items-center h-10 whitespace-nowrap truncate"
      >
        주소
      </div>
      {#each seongdos as item}
