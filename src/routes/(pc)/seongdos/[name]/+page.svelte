<script lang="ts">
  ...
  import { Checkmark, Close, TrashCan } from "carbon-icons-svelte"
...
<div
  id="content"
  class="sm:px-16 px-6 py-8 flex flex-col w-full bg-white overflow-scroll"
>
  ...
  <div class="flex flex-col w-full-if-mobile">
    <h1 class="text-lg font-medium mt-10 mb-2">수강 내역</h1>
    <div class="flex flex-col overflow-scroll">
      <TableForEdu educations={[...educations]} type="seongdo" />
    </div>
  </div>
</div>
